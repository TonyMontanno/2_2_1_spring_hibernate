...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      User user1 = new User("Franchesco","Gudini","Franco@gmail.com");
      User user2 = new User("Fernando","Gobaldi","Fernando@gmail.com");
      User user3 = new User("Tony","Montano","Tony@gmail.com");
